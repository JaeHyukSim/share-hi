<template>
  <div class="login-container">
    ...
    <div class="login-btn-box">
      <span class="new-tab-link" @click="onClickSignup('https://localhost/user/signup/')">회원가입</span>
      <span class="new-tab-link" @click="onClickFindPassword('https://localhost/user/login/')">비밀번호 찾기</span>
    </div>
  </div>
</template>
